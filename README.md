...
最新版 **v1.1.1**（Android 8.0+，无需 Root）。两个包功能完全相同，**任选一个**：
...
- 精简版 → [`TrailRun-1.1.1.apk`](https://cdn.jsdelivr.net/gh/wangwangrr/TrailRun@main/release/TrailRun-1.1.1.apk)
- 调试版 → [`TrailRun-1.1.1-debug.apk`](https://cdn.jsdelivr.net/gh/wangwangrr/TrailRun@main/release/TrailRun-1.1.1-debug.apk)
